...
public class ErrorMessage {
    ...
    public static final String HOTEL_OCUPADO = "O hotel não possui quartos para esta data";
    public static final String HOTEL_NAO_ENCONTRADO = "Nenhum Hotel com este nome foi encontrado";
